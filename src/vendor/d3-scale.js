...
function ordinal() {
  var index2 = new Map(), domain = [], range = [], unknown = implicit;
  function scale(d) {
...
function calendar(year2, month2, week, day2, hour2, minute2, second2, millisecond2, format2) {
  ...
  scale.ticks = function(interval) {
    ...
    if (r)
      t = t03, t03 = t13, t13 = t;
    t = tickInterval(interval, t03, t13);
  ...
  scale.nice = function(interval) {
    var d = domain();
    return (interval = tickInterval(interval, d[0], d[d.length - 1])) ? domain(nice2(d, interval)) : scale;
  };
  scale.copy = function() {
